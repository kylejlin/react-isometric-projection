...
var _createCoordCalculator = __webpack_require__(4);
...
function IsometricProjection(_ref) {
  var size = _ref.size,
      x = _ref.x,
      y = _ref.y,
      meshDef = _ref.meshDef;

  var calculate = (0, _createCoordCalculator2.default)(width);
  var vbd = meshDef.viewBoxDimensions,
      polygons = meshDef.polygons;
  ...
  var scaledPolygons = polygons.map(function (_ref2) {
    ...
    return {
      ...
      points: points.map(function (_ref3) {
        ...
        return [x / vbd.x, y / vbd.y, z / vbd.z];
      })
    };
  });
  scaledPolygons.sort(function (_ref5, _ref6) {
    var a = _ref5.points;
    var b = _ref6.points;

    var aGreatestPointSum = Math.max.apply(Math, _toConsumableArray(a.map(function (_ref7) {
    ...
    var bGreatestPointSum = Math.max.apply(Math, _toConsumableArray(b.map(function (_ref9) {
  ...
  var renderPolygons = scaledPolygons.map(function (_ref11) {
    var color = _ref11.color,
        points = _ref11.points;
    return {
      color: color,
      points: points.map(function (_ref12) {
  ...
  return _react2.default.createElement(
    ...
    renderPolygons.map(function (_ref14, i) {
      ...
      return _react2.default.createElement('polygon', { key: i, points: pointStr, fill: color });
    })
  );
}
...
var _MeshDefinition = __webpack_require__(7);
...
var _Pyramid = __webpack_require__(8);
...
var _IsometricProjection = __webpack_require__(2);
...
var _flattenTagsIntoPolyArr = __webpack_require__(10);
...
exports.default = function (_ref) {
  ...
  var bp = parseVector(basePoints);
  var tp = parseVector(tipPoint);
  var pc = parseColors(colors, bp.length + 1);

  return bp.reduce(function (arr, basePoint, i) {
    var nextIndex = i + 1;
    var nextPoint = nextIndex < bp.length ? bp[nextIndex] : bp[0];
    return arr.concat([React.createElement(Polgon, { color: pc[i + 1], points: [basePoint, tipPoint, nextPoint] })]);
  }, [React.createElement(Polygon, { color: pc[0], points: bp })]);
};
...
var _jsxToObj = __webpack_require__(11);

var _jsxToObj2 = _interopRequireDefault(_jsxToObj);

var _parseColors = __webpack_require__(12);
